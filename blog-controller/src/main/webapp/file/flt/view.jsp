...
<script type="text/javascript">
	...
	function submitData(){
		...
		if(content==null || content==''){
			...
			$.post("${cxt}/comment/save.shtml",{'content':content,'imageCode':imageCode,'blogId':'${blog.id}'},function(result){
				if(result.success){
			...
			<c:choose>
				...
				<c:otherwise>
					<c:forEach var="keyWord" items="${keyWords }">
						&nbsp;&nbsp;<a href="${cxt}/blog/q.shtml?q=${keyWord}" target="_blank">${keyWord }</a>&nbsp;&nbsp;
					</c:forEach>
				</c:otherwise>
			</c:choose>
		</div>
