...
<script type="text/javascript">
	...
	function deleteLink(){
		...
		if(selectedRows.length==0){
		 ...
		 $.messager.confirm("系统提示","您确定要删除这<font color=red>"+selectedRows.length+"</font>条数据吗？",function(r){
				if(r){
					$.post("${cxt}/admin/link/delete.shtml",{ids:ids},function(result){
						if(result.success){
	...
	function openLinkModifyDialog(){
		var selectedRows=$("#dg").datagrid("getSelections");
		 ...
		 $("#fm").form("load",row);
		 url="${cxt}/admin/link/modify.shtml?id="+row.id;
	 }
...
<table id="dg" title="友情友情链接管理" class="easyui-datagrid"
   ...
   url="${cxt}/admin/link/list.shtml" fit="true" toolbar="#tb"
