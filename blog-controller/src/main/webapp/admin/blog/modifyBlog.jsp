...
<script type="text/javascript">
	...
	function submitData(){
		...
		if(title==null || title==''){
			...
			$.ajax({
				type : "post",
				url : "${cxt}/admin/blog/modify.shtml", 
		...
		/* 	$.post("${cxt}/admin/blog/modify.shtml",
...
<div id="p" class="easyui-panel" title="修改博客" style="padding: 10px">
   		...
   		<tr>
   			...
   			<td>
   				<select class="easyui-combobox" style="width: 154px" id="blogTypeId" name="typeId" editable="false" panelHeight="auto"  value="">
				    ...
				    <c:forEach var="blogType" items="${typeList }">
 ...
 <script type="text/javascript">
    ...
    ue.addListener("ready",function(){
        //通过ajax请求数据
        UE.ajax.request("${cxt}/admin/blog/${param.id}/getById.shtml",
            {
                method:"post",
                async : false,  
               // data:{"id":"${param.id}"},
