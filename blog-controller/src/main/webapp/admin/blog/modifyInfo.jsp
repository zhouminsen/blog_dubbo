...
<head>
    ...
    <script type="text/javascript">
        ...
        function uploadPic(val) {
            ...
            //定义参数
            var options = {
                url: "${cxt}/admin/user/uploadPic.shtml",
                dataType: "json",
                type: "post",
        ...
        function uploadPicJersey(val) {
            ...
            //定义参数
            var options = {
                url: "${cxt}/admin/user/uploadPicJersey.shtml",
                dataType: "json",
                type: "post",
                success: function (data) {
                    if (!data.success) {
...
<div id="p" class="easyui-panel" title="修改个人信息" style="padding: 10px">
    <form id="form1" action="${cxt}/admin/user/modify.shtml" method="post" enctype="multipart/form-data">
...
<script type="text/javascript">
    ...
    ue.addListener("ready", function () {
        //通过ajax请求数据
        UE.ajax.request("${cxt}/admin/user/${currentUser.id}/getById.shtml",
                {
                    method: "post",
                    async: false,
                    data: {},
