...
<head>
    ...
    <script type="text/javascript">
        ...
        $(function () {
            ...
            $("#dg").datagrid({
                url: "${cxt}/admin/download/list.shtml?v=" + Math.random(),
                //数据表格的数据
                title: "文件下载",
                        ...
                        if (flag) {
                            ...
                            $.messager.confirm("删除", "你确定要删除吗?", function (t) {
                                if (t) {
                                    ...
                                    $.post("${cxt}/admin/download/delete.shtml?v=" + Math.random(), {"ids": ids}, function (result) {
                                        if (result) {
                ...
                onAfterEdit: function (index, row) {
                    //直接把数据更新到服务器
                    if (method == "save") {
                        $.post("${cxt}/admin/download/save.shtml?v=" + Math.random(), row, function (result) {
                        ...
                        $.ajax({
                            url: "${cxt}/admin/download/modify.shtml?v=" + Math.random(),
                            data: row,
                            dataType: "json",
                            type: "post",
                ...
                columns: [[
                    {field: "id", title: "编号", width: 100, align: "center", checkbox: true},//列的属性
                    {
                        ...
                        formatter: function (val, row, index) {
                            return "<a href='${cxt}/admin/download/download.shtml?fileName="+val+"'>"+val+"</a>";
                        },
                        editor: {
                            type: "validatebox",
                            options: {
