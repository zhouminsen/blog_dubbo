...
public class PrivilegeTag extends TagSupport {
    ...
    public int doStartTag() throws JspException {
        Set<String> permissionList = (Set<String>) SecurityUtils.getSubject().getSession().getAttribute("permissionList");
        if (!permissionList.isEmpty() && UtilFuns.existElements(operationId, permissionList)) {
