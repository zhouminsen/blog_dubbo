...
public class LogOperationAop {
     ...
     * @param joinPoint
     */
    @Before("execution(* org.zjw.blog.service.impl.*.*(..))")
...
//		System.out.println("******参数" + list + "******");
     ...
     * @param joinPoint
     */
    @After("execution(* org.zjw.blog.service.impl.*.*(..))")
...
//		System.out.println(rightnow + "执行了【" + object + "方法结束......】");
     ...
     * @param result
     */
    @AfterReturning(value = "execution(* org.zjw.blog.service.impl.*.modify*(..)) "
            + "|| execution(* org.zjw.blog.service.impl.*.delete*(..)) "
            + "|| execution(* org.zjw.blog.service.impl.*.save*(..))"
            + "|| execution(* org.zjw.blog.service.impl.*.backup*(..))", returning = "result")
    public void afterReturn(JoinPoint joinPoint, Object result) {
        ...
        try {
            ...
            //得到ip地址
                logOperation.setIpAddress("127.0.0.1");
            //得到模块名
